...
@section('content')
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item active">
                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile"
                       aria-selected="false">Create new Lead</a>
                </li>
                @endif
            </ul>
    ...
    <div class="card-box">
        <h4 class="m-t-0 header-title">Import leads</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <a href="{{ url('assets/files/leads_example.xlsx') }}" class="btn btn-danger waves-effect waves-light"><i class="fa fa-fw fa-download"></i> Download Lead Excel Example</a>
            </div>
        </div>
